...
if (arguments != 6):
    print("Error: Usage createdatafile.py modiscurrentnamelistfile workrawfile workrawdir regionfile worksurffile worksurfdir")
    sys.exit()
else:
...
worksurfoutputparts = modiscurrentnamelist[2].split()
worksurfoutput = worksurfoutputparts[1]
worksurfoutputnameparts = modiscurrentnamelist[3].split()
