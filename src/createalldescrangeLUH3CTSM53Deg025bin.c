...
char namelistluh3descallrangeallpftname[1024];
char namelistluh3descrawpftoutput[1024];
char namelistluh3descrawpftoutputrangename[1024];
...
char namelistworkrawforestmaxvcfinputrangename[1024];
...
float inPOTVEGMAXRANGEPCTTREEGrid[MAXCLMPIX * MAXCLMLIN];
float inPOTVEGMAXRANGEPCTHERBGrid[MAXCLMPIX * MAXCLMLIN];
float inPOTVEGMAXRANGEPCTBAREGrid[MAXCLMPIX * MAXCLMLIN];

float inPOTVEGSCALEDRANGEPCTTREEGrid[MAXCLMPIX * MAXCLMLIN];
float inPOTVEGSCALEDRANGEPCTHERBGrid[MAXCLMPIX * MAXCLMLIN];
float inPOTVEGSCALEDRANGEPCTBAREGrid[MAXCLMPIX * MAXCLMLIN];
...
float inMERGEDRANGEFRACTREEGrid[MAXCLMPIX * MAXCLMLIN];
float inMERGEDRANGEFRACHERBGrid[MAXCLMPIX * MAXCLMLIN];
float inMERGEDRANGEFRACBAREGrid[MAXCLMPIX * MAXCLMLIN];
...
int readnamelistfile(char *namelist) {
  ...
  fscanf(namelistfile,"%s %s",fieldname,namelistluh3descallrangeallpftname);
  fscanf(namelistfile,"%s %s",fieldname,namelistluh3descrawpftoutput);
  fscanf(namelistfile,"%s %s",fieldname,namelistluh3descrawpftoutputrangename);
  ...
  fscanf(namelistfile,"%s %s",fieldname,namelistworkrawforestmaxvcfinputrangename);
...
int readpotvegmaxrangevcfGrids(char *databasestr,char *seriesname,char *referenceyearname) {
  ...
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inPOTVEGMAXRANGEPCTTREEGrid,sizeof(inPOTVEGMAXRANGEPCTTREEGrid),1,globalbinfile);  
  fclose(globalbinfile);

  sprintf(globalbinfilename,"%s/%s/%s.PCTHERB.%s.dat",databasestr,seriesname,seriesname,referenceyearname);
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inPOTVEGMAXRANGEPCTHERBGrid,sizeof(inPOTVEGMAXRANGEPCTHERBGrid),1,globalbinfile);  
  fclose(globalbinfile);

  sprintf(globalbinfilename,"%s/%s/%s.PCTBARE.%s.dat",databasestr,seriesname,seriesname,referenceyearname);
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inPOTVEGMAXRANGEPCTBAREGrid,sizeof(inPOTVEGMAXRANGEPCTBAREGrid),1,globalbinfile);  
  fclose(globalbinfile);
...
int readpotvegscaledrangevcfGrids(char *databasestr,char *seriesname,char *referenceyearname) {
  ...
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inPOTVEGSCALEDRANGEPCTTREEGrid,sizeof(inPOTVEGSCALEDRANGEPCTTREEGrid),1,globalbinfile);  
  fclose(globalbinfile);

  sprintf(globalbinfilename,"%s/%s/%s.PCTHERB.%s.dat",databasestr,seriesname,seriesname,referenceyearname);
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inPOTVEGSCALEDRANGEPCTHERBGrid,sizeof(inPOTVEGSCALEDRANGEPCTHERBGrid),1,globalbinfile);  
  fclose(globalbinfile);

  sprintf(globalbinfilename,"%s/%s/%s.PCTBARE.%s.dat",databasestr,seriesname,seriesname,referenceyearname);
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inPOTVEGSCALEDRANGEPCTBAREGrid,sizeof(inPOTVEGSCALEDRANGEPCTBAREGrid),1,globalbinfile);  
  fclose(globalbinfile);
...
int readmworkergedRANGEGrids(char *databasestr,char *seriesname,char *referenceyearname) {
  ...
  sprintf(globalbinfilename,"%s/%s/%s.RANGEFRACTREE.%s.dat",databasestr,seriesname,seriesname,referenceyearname);
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inMERGEDRANGEFRACTREEGrid,sizeof(inMERGEDRANGEFRACTREEGrid),1,globalbinfile);  
  fclose(globalbinfile);

  sprintf(globalbinfilename,"%s/%s/%s.RANGEFRACHERB.%s.dat",databasestr,seriesname,seriesname,referenceyearname);
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inMERGEDRANGEFRACHERBGrid,sizeof(inMERGEDRANGEFRACHERBGrid),1,globalbinfile);  
  fclose(globalbinfile);

  sprintf(globalbinfilename,"%s/%s/%s.RANGEFRACBARE.%s.dat",databasestr,seriesname,seriesname,referenceyearname);
  printf("Reading: %s\n",globalbinfilename);
  globalbinfile = fopen(globalbinfilename,"r");
  fread(inMERGEDRANGEFRACBAREGrid,sizeof(inMERGEDRANGEFRACBAREGrid),1,globalbinfile);  
  fclose(globalbinfile);
...
int genMergedDescriptorVegGrids() {
  ...
  float rangetreepct, rangeherbpct, rangebarepct, rangeallpct;
  float potvegmaxtreepct, potvegscaledtreepct, mergedprimffractree;
  float potvegmaxherbpct, potvegscaledherbpct, mergedprimffracherb;
  float potvegmaxbarepct, potvegscaledbarepct, mergedprimffracbare;
  float addpct, removepct;
  float rangendlevgtreepct, rangendldectreepct, rangebrdevgtreepct, rangebrddectreepct, rangeshrpct, rangegrsc3pct, rangegrsc4pct;
  float rangealltreepct, rangeallherbpct;
  float rangendlevgtemptreepct, rangendlevgborltreepct, rangendldecborltreepct;
  float rangebrdevgtroptreepct, rangebrddectroptreepct, rangebrdevgtemptreepct, rangebrddectemptreepct, rangebrddecborltreepct;
  float rangeshrevgtemppct, rangeshrdectemppct, rangeshrdecborlpct, rangegrsc3arcpct, rangegrsc3nonpct, rangegrsc4nonpct;
  ...
  for (clm5lin = 0; clm5lin < MAXCLMLIN; clm5lin++) {
	  ...
	  if (landfrac > 0.0) {
	      ...
	      potvegmaxtreepct = inPOTVEGMAXRANGEPCTTREEGrid[clm5lin * MAXCLMPIX + clm5pix];
	      potvegscaledtreepct = inPOTVEGSCALEDRANGEPCTTREEGrid[clm5lin * MAXCLMPIX + clm5pix];
	      mergedprimffractree = inMERGEDRANGEFRACTREEGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangetreepct = mergedprimffractree * potvegmaxtreepct + (1.0 - mergedprimffractree) * potvegscaledtreepct;
	      
	      potvegmaxherbpct = inPOTVEGMAXRANGEPCTHERBGrid[clm5lin * MAXCLMPIX + clm5pix];
	      potvegscaledherbpct = inPOTVEGSCALEDRANGEPCTHERBGrid[clm5lin * MAXCLMPIX + clm5pix];
	      mergedprimffracherb = inMERGEDRANGEFRACHERBGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangeherbpct = mergedprimffracherb * potvegmaxherbpct + (1.0 - mergedprimffracherb) * potvegscaledherbpct;
	      
	      potvegmaxbarepct = inPOTVEGMAXRANGEPCTBAREGrid[clm5lin * MAXCLMPIX + clm5pix];
	      potvegscaledbarepct = inPOTVEGSCALEDRANGEPCTBAREGrid[clm5lin * MAXCLMPIX + clm5pix];
	      mergedprimffracbare = inMERGEDRANGEFRACBAREGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangebarepct = mergedprimffracbare * potvegmaxbarepct + (1.0 - mergedprimffracbare) * potvegscaledbarepct;
		  ...
		  if (rangetreepct > rangeherbpct) {
		      rangetreepct += addpct;
		      addpct = 0.0;
		  }
		  else {
		      if (rangeherbpct > rangebarepct) {
		          rangeherbpct += addpct;
		          addpct = 0.0;
		      }
		      else {
	      ...
	      rangendlevgtreepct = inCTSMTREEEXTRAPPCTNDLEVGTREEGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangendldectreepct = inCTSMTREEEXTRAPPCTNDLDECTREEGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangebrdevgtreepct = inCTSMTREEEXTRAPPCTBRDEVGTREEGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangebrddectreepct = inCTSMTREEEXTRAPPCTBRDDECTREEGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangealltreepct = rangendlevgtreepct + rangendldectreepct + rangebrdevgtreepct + rangebrddectreepct;
	      
	      if (rangealltreepct > 0.0) {
	          rangendlevgtreepct = rangendlevgtreepct / rangealltreepct * rangetreepct;
                  rangendlevgtreepct = trunc(rangendlevgtreepct * CLMPCTTruncate) / CLMPCTTruncate;
	          rangendldectreepct = rangendldectreepct / rangealltreepct * rangetreepct;
                  rangendldectreepct = trunc(rangendldectreepct * CLMPCTTruncate) / CLMPCTTruncate;
	          rangebrdevgtreepct = rangebrdevgtreepct / rangealltreepct * rangetreepct;
                  rangebrdevgtreepct = trunc(rangebrdevgtreepct * CLMPCTTruncate) / CLMPCTTruncate;
	          rangebrddectreepct = rangebrddectreepct / rangealltreepct * rangetreepct;
                  rangebrddectreepct = trunc(rangebrddectreepct * CLMPCTTruncate) / CLMPCTTruncate;
              }
	      
              if (tempcoldestvalue > -19.0 && growdegdaysvalue > 1200.0) {
                  rangendlevgtemptreepct = rangendlevgtreepct + rangendldectreepct;
                  rangendlevgborltreepct = 0.0;
                  rangendldecborltreepct = 0.0;
              }
	      else {
	          rangendlevgtemptreepct = 0.0;
		  rangendlevgborltreepct = rangendlevgtreepct;
		  rangendldecborltreepct = rangendldectreepct;
              }

              if ((tempcoldestvalue < 10.0 && rangebrdevgtreepct < 1.0 && clm5lin < MAXCLMLIN / 2) || (tempcoldestvalue < 0.0 && rangebrdevgtreepct < 1.0)) {                   rangebrddectreepct = rangebrddectreepct + rangebrdevgtreepct;
		  rangebrdevgtreepct = 0.0;
              } 
	      
              if (tempcoldestvalue > 15.0) {
	          rangebrdevgtroptreepct = rangebrdevgtreepct;
		  rangebrdevgtemptreepct = 0.0;
              }
	      else {
		  rangebrdevgtroptreepct = 0.0;
	          rangebrdevgtemptreepct = rangebrdevgtreepct;
	      }
	      
              if (tempcoldestvalue > 15.0) {
                  rangebrddectroptreepct = rangebrddectreepct;
                  rangebrddectemptreepct = 0.0;
                  rangebrddecborltreepct = 0.0;
	      }
	      else {
                  if (tempcoldestvalue > -15.0 && growdegdaysvalue > 1200.0) {
                      rangebrddectroptreepct = 0.0;
                      rangebrddectemptreepct = rangebrddectreepct;
                      rangebrddecborltreepct = 0.0;
		  }
		  else {
                      rangebrddectroptreepct = 0.0;
                      rangebrddectemptreepct = 0.0;
                      rangebrddecborltreepct = rangebrddectreepct;
		  }
              }
	      
	      rangeshrpct = inCTSMHERBEXTRAPPCTSHRGrid[clm5lin * MAXCLMPIX + clm5pix];
	      rangegrsc3pct = inCTSMHERBEXTRAPPCTGRSC3Grid[clm5lin * MAXCLMPIX + clm5pix];
	      rangegrsc4pct = inCTSMHERBEXTRAPPCTGRSC4Grid[clm5lin * MAXCLMPIX + clm5pix];
              rangeallherbpct = rangeshrpct + rangegrsc3pct + rangegrsc4pct;
	      
	      if (rangeallherbpct > 0.0) {
	          rangeshrpct = rangeshrpct / rangeallherbpct * rangeherbpct;
                  rangeshrpct = trunc(rangeshrpct * CLMPCTTruncate) / CLMPCTTruncate;
	          rangegrsc3pct = rangegrsc3pct / rangeallherbpct * rangeherbpct;
                  rangegrsc3pct = trunc(rangegrsc3pct * CLMPCTTruncate) / CLMPCTTruncate;
	          rangegrsc4pct = rangegrsc4pct / rangeallherbpct * rangeherbpct;
                  rangegrsc4pct = trunc(rangegrsc4pct * CLMPCTTruncate) / CLMPCTTruncate;
              }
	      
              if ((tempcoldestvalue > -19.0 && growdegdaysvalue > 1200.0) && (precipannvalue > 520.0 && precipwinvalue > (precipannvalue * 2.0 / 3.0))) {
	          rangeshrevgtemppct = rangeshrpct;
		  rangeshrdectemppct = 0.0;
		  rangeshrdecborlpct = 0.0;
	      }
	      else {
		  if (tempcoldestvalue > -19.0 && growdegdaysvalue > 1200.0) {
                      rangeshrevgtemppct = 0.0;
                      rangeshrdectemppct = rangeshrpct;
                      rangeshrdecborlpct = 0.0;
                  }
                  else {
                      rangeshrevgtemppct = 0.0;
                      rangeshrdectemppct = 0.0;
                      rangeshrdecborlpct = rangeshrpct;
                  }
	      }
	      
              if (growdegdaysvalue <= 1000.0) {
                  rangegrsc3arcpct = rangegrsc3pct + rangegrsc4pct;
                  rangegrsc3nonpct = 0.0;
                  rangegrsc4nonpct = 0.0;
              }
              else {
                  if (tempcoldestvalue > 22.0 && precipminvalue > 25.0) {
                      rangegrsc3arcpct = 0.0;
                      rangegrsc3nonpct = 0.0;
                      rangegrsc4nonpct = rangegrsc3pct + rangegrsc4pct;
		  }
		  else {
                      rangegrsc3arcpct = 0.0;
                      rangegrsc3nonpct = rangegrsc3pct;
                      rangegrsc4nonpct = rangegrsc4pct;
		  }
              }
	      
	      outDESCMERGEDPCTPFTGrid[0][clm5lin * MAXCLMPIX + clm5pix] = rangebarepct;
	      outDESCMERGEDPCTPFTGrid[1][clm5lin * MAXCLMPIX + clm5pix] = rangendlevgtemptreepct;		  
	      outDESCMERGEDPCTPFTGrid[2][clm5lin * MAXCLMPIX + clm5pix] = rangendlevgborltreepct;		  
	      outDESCMERGEDPCTPFTGrid[3][clm5lin * MAXCLMPIX + clm5pix] = rangendldecborltreepct;		  
	      outDESCMERGEDPCTPFTGrid[4][clm5lin * MAXCLMPIX + clm5pix] = rangebrdevgtroptreepct;		  
	      outDESCMERGEDPCTPFTGrid[5][clm5lin * MAXCLMPIX + clm5pix] = rangebrdevgtemptreepct;		  
	      outDESCMERGEDPCTPFTGrid[6][clm5lin * MAXCLMPIX + clm5pix] = rangebrddectroptreepct;		  
	      outDESCMERGEDPCTPFTGrid[7][clm5lin * MAXCLMPIX + clm5pix] = rangebrddectemptreepct;		  
	      outDESCMERGEDPCTPFTGrid[8][clm5lin * MAXCLMPIX + clm5pix] = rangebrddecborltreepct;		  
	      outDESCMERGEDPCTPFTGrid[9][clm5lin * MAXCLMPIX + clm5pix] = rangeshrevgtemppct;
	      outDESCMERGEDPCTPFTGrid[10][clm5lin * MAXCLMPIX + clm5pix] = rangeshrdectemppct;
	      outDESCMERGEDPCTPFTGrid[11][clm5lin * MAXCLMPIX + clm5pix] = rangeshrdecborlpct;
	      outDESCMERGEDPCTPFTGrid[12][clm5lin * MAXCLMPIX + clm5pix] = rangegrsc3arcpct;
	      outDESCMERGEDPCTPFTGrid[13][clm5lin * MAXCLMPIX + clm5pix] = rangegrsc3nonpct;
	      outDESCMERGEDPCTPFTGrid[14][clm5lin * MAXCLMPIX + clm5pix] = rangegrsc4nonpct; 
	  }
      }
  }
...
int balanceMergedDescriptorVegGrids() {
  ...
  long clm5lin, clm5pix;
  long pftid, rangemaxpftid;
  float landmask, landfrac, area, precipann, tempaverage;
  float rangepftpct, rangemaxpftpct, rangeallpftpct;
  float rangeremovepct, rangeaddpct;
  ...
  for (clm5lin = 0; clm5lin < MAXCLMLIN; clm5lin++) {
	  ...
	  if (landfrac > 0.0) {
	      ...
	      for (pftid = 0; pftid < MAXPFT; pftid++) {
	          rangepftpct = outDESCMERGEDPCTPFTGrid[pftid][clm5lin * MAXCLMPIX + clm5pix];
		  rangeallpftpct += rangepftpct;
		  if (rangepftpct > rangemaxpftpct) {
		      rangemaxpftpct = rangepftpct;
		      rangemaxpftid = pftid;
		  }
              }
	      
	      if (rangeallpftpct > 100.0) {
	          rangeremovepct = rangeallpftpct - 100.0;
	          outDESCMERGEDPCTPFTGrid[rangemaxpftid][clm5lin * MAXCLMPIX + clm5pix] -= rangeremovepct;
              }
	      
	      if (rangeallpftpct < 100.0) {
	          rangeaddpct = 100.0 - rangeallpftpct;
	          outDESCMERGEDPCTPFTGrid[rangemaxpftid][clm5lin * MAXCLMPIX + clm5pix] += rangeaddpct;
              }
...
int main(long narg, char **argv) {
  ...
  if(narg != 8){
        printf("Usage createalldescrangeCTSM53Deg025bin luh3descrawfile luh3descrawdir timeseriesrawfile timeseriesrawdir workrawfile workrawdir luh3descrangepftnamelistfile\n");
        return 0;
  }
  ...
  readpotvegmaxrangevcfGrids(workrawforestmaxvcfinputdirname,namelistworkrawforestmaxvcfinputrangename,workrawforestmaxvcfinputreferenceyearstr);    
  readpotvegscaledrangevcfGrids(workrawscaledvcfinputdirname,namelistworkrawscaledvcfinputrangename,workrawscaledvcfinputreferenceyearstr);    
  ...
  for (currentyear = workrawmergeinputstartyear; currentyear <= workrawmergeinputendyear; currentyear++) {
      ...
      clearGrids();
      readmworkergedRANGEGrids(workrawmergeinputdirname,namelistworkrawmergeinputname,workrawmergeinputreferenceyearstr);
      genMergedDescriptorVegGrids();
      balanceMergedDescriptorVegGrids();
      writedescmergedgrids(luh3descrawpftoutputdirname,namelistluh3descrawpftoutputrangename,luh3descrawpftoutputreferenceyearstr);
  }
