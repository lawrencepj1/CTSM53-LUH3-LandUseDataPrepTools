...
char namelistrangetreeclimatename[1024];
char namelistrangeherbclimatename[1024];
char namelistrangebareclimatename[1024];
...
char rangetreeclimatename[1024];
char rangetreeclimatedb[1024];
int rangetreeclimatestartyear;
int rangetreeclimateendyear;

char rangeherbclimatename[1024];
char rangeherbclimatedb[1024];
int rangeherbclimatestartyear;
int rangeherbclimateendyear;

char rangebareclimatename[1024];
char rangebareclimatedb[1024];
int rangebareclimatestartyear;
int rangebareclimateendyear;

float rangepotentialtree[PRECIPCLASSES][TEMPCLASSES];
float rangepotentialherb[PRECIPCLASSES][TEMPCLASSES];
float rangepotentialbare[PRECIPCLASSES][TEMPCLASSES];
...
int readnamelistfile(char *namelist) {
  ...
  fscanf(namelistfile,"%s %s",fieldname,namelistrangetreeclimatename);
  fscanf(namelistfile,"%s %s",fieldname,namelistrangeherbclimatename);
  fscanf(namelistfile,"%s %s",fieldname,namelistrangebareclimatename);
...
int readrangetreeclimatelutfile(char *filenamestr, char *dirnamestr, char *namestr) {

  FILE *rangetreeclimatevaluefile;
  int foundrangetreeclimate, itemsfound;
  char fullfilenamestr[1024], inrangetreeclimatename[1024], inrangetreeclimatedb[1024], inrangetreeclimatefile[1024];
  char inrangetreeclimatestartyear[1024], inrangetreeclimateendyear[1024];
  
  sprintf(fullfilenamestr,"%s",filenamestr);
  printf("Reading %s\n",fullfilenamestr);
  rangetreeclimatevaluefile = fopen(fullfilenamestr,"r");
  
  foundrangetreeclimate = 0;

  while (foundrangetreeclimate == 0) {
      itemsfound = fscanf(rangetreeclimatevaluefile,"%s %s %s %s %s",inrangetreeclimatename, inrangetreeclimatedb, inrangetreeclimatefile, inrangetreeclimatestartyear, inrangetreeclimateendyear);
      if (itemsfound != 5) {
          printf("Error: rangetreeclimate %s Not Found\n",namestr);
	  exit(0);
      }
      if (strcmp(namestr,inrangetreeclimatename) == 0) {
          printf("Processing rangetreeclimate: %s\n",inrangetreeclimatename);
	  sprintf(rangetreeclimatename,"%s",inrangetreeclimatename);
          if (strcmp(inrangetreeclimatedb,"<luh3modiscrurawdir>") == 0) {
              sprintf(rangetreeclimatedb,"%s%s",dirnamestr,inrangetreeclimatefile);
	  }
	  else {
              sprintf(rangetreeclimatedb,"%s%s",inrangetreeclimatedb,inrangetreeclimatefile);
	  }
          rangetreeclimatestartyear = atoi(inrangetreeclimatestartyear);
          rangetreeclimateendyear = atoi(inrangetreeclimateendyear);
	  foundrangetreeclimate = 1;
      }
  }  
...
int readrangeherbclimatelutfile(char *filenamestr, char *dirnamestr, char *namestr) {

  FILE *rangeherbclimatevaluefile;
  int foundrangeherbclimate, itemsfound;
  char fullfilenamestr[1024], inrangeherbclimatename[1024], inrangeherbclimatedb[1024], inrangeherbclimatefile[1024];
  char inrangeherbclimatestartyear[1024], inrangeherbclimateendyear[1024];
  
  sprintf(fullfilenamestr,"%s",filenamestr);
  printf("Reading %s\n",fullfilenamestr);
  rangeherbclimatevaluefile = fopen(fullfilenamestr,"r");
  
  foundrangeherbclimate = 0;

  while (foundrangeherbclimate == 0) {
      itemsfound = fscanf(rangeherbclimatevaluefile,"%s %s %s %s %s",inrangeherbclimatename, inrangeherbclimatedb, inrangeherbclimatefile, inrangeherbclimatestartyear, inrangeherbclimateendyear);
      if (itemsfound != 5) {
          printf("Error: rangeherbclimate %s Not Found\n",namestr);
	  exit(0);
      }
      if (strcmp(namestr,inrangeherbclimatename) == 0) {
          printf("Processing rangeherbclimate: %s\n",inrangeherbclimatename);
	  sprintf(rangeherbclimatename,"%s",inrangeherbclimatename);
          if (strcmp(inrangeherbclimatedb,"<luh3modiscrurawdir>") == 0) {
              sprintf(rangeherbclimatedb,"%s%s",dirnamestr,inrangeherbclimatefile);
	  }
	  else {
              sprintf(rangeherbclimatedb,"%s%s",inrangeherbclimatedb,inrangeherbclimatefile);
	  }
          rangeherbclimatestartyear = atoi(inrangeherbclimatestartyear);
          rangeherbclimateendyear = atoi(inrangeherbclimateendyear);
	  foundrangeherbclimate = 1;
      }
  }  
...
int readrangebareclimatelutfile(char *filenamestr, char *dirnamestr, char *namestr) {

  FILE *rangebareclimatevaluefile;
  int foundrangebareclimate, itemsfound;
  char fullfilenamestr[1024], inrangebareclimatename[1024], inrangebareclimatedb[1024], inrangebareclimatefile[1024];
  char inrangebareclimatestartyear[1024], inrangebareclimateendyear[1024];
  
  sprintf(fullfilenamestr,"%s",filenamestr);
  printf("Reading %s\n",fullfilenamestr);
  rangebareclimatevaluefile = fopen(fullfilenamestr,"r");
  
  foundrangebareclimate = 0;

  while (foundrangebareclimate == 0) {
      itemsfound = fscanf(rangebareclimatevaluefile,"%s %s %s %s %s",inrangebareclimatename, inrangebareclimatedb, inrangebareclimatefile, inrangebareclimatestartyear, inrangebareclimateendyear);
      if (itemsfound != 5) {
          printf("Error: rangebareclimate %s Not Found\n",namestr);
	  exit(0);
      }
      if (strcmp(namestr,inrangebareclimatename) == 0) {
          printf("Processing rangebareclimate: %s\n",inrangebareclimatename);
	  sprintf(rangebareclimatename,"%s",inrangebareclimatename);
          if (strcmp(inrangebareclimatedb,"<luh3modiscrurawdir>") == 0) {
              sprintf(rangebareclimatedb,"%s%s",dirnamestr,inrangebareclimatefile);
	  }
	  else {
              sprintf(rangebareclimatedb,"%s%s",inrangebareclimatedb,inrangebareclimatefile);
	  }
          rangebareclimatestartyear = atoi(inrangebareclimatestartyear);
          rangebareclimateendyear = atoi(inrangebareclimateendyear);
	  foundrangebareclimate = 1;
      }
  }  
...
int readpotentialveglut(char *filenamestr, int veglutid) {
  ...
  for (precipannindex = 0; precipannindex < PRECIPCLASSES; precipannindex++) {
	  ...
	  tempfloatvalue = atof(temptokenvalue);
          switch (veglutid) {
              case 1 : 
                  rangepotentialtree[precipannindex][tempaverageindex] = tempfloatvalue;
                  break;
              case 2 : 
                  rangepotentialherb[precipannindex][tempaverageindex] = tempfloatvalue;
                  break;
              case 3 : 
                  rangepotentialbare[precipannindex][tempaverageindex] = tempfloatvalue;
                  break;
          }
...
int printpotentialveglut(int veglutid) {
  ...
  for (precipannindex = 0; precipannindex < PRECIPCLASSES; precipannindex++) {
      ...
      for (tempaverageindex = 0; tempaverageindex < TEMPCLASSES; tempaverageindex++) {
          ...
          switch (veglutid) {
              case 1 : 
                  printf("%f %f - %f\n",precipannvalue,tempaveragevalue,rangepotentialtree[precipannindexcalc][tempaverageindexcalc]);
                  break;
              case 2 : 
                  printf("%f %f - %f\n",precipannvalue,tempaveragevalue,rangepotentialherb[precipannindexcalc][tempaverageindexcalc]);
                  break;
              case 3 : 
                  printf("%f %f - %f\n",precipannvalue,tempaveragevalue,rangepotentialbare[precipannindexcalc][tempaverageindexcalc]);
                  break;
          }
      }
  }
...
int genLUHPotentialVegGrids() {
  ...
  for (clm5lin = 0; clm5lin < MAXCLMLIN; clm5lin++) {
	  ...
	  if (landfrac > 0.0) {
	      ...
	      potvegtreepct = rangepotentialtree[precipannindex][tempaverageindex];
	      potvegherbpct = rangepotentialherb[precipannindex][tempaverageindex];
	      potvegbarepct = rangepotentialbare[precipannindex][tempaverageindex];
...
int main(long narg, char **argv) {
  ...
  if(narg != 8){
        printf("Usage createpotvegpftsclm552Deg025bin timeseriesrawfile timeseriesrawdir workrawfile workrawdir luh3modiscruclimatefile luh3modiscrurawdir generaterangepotveginitialvcfnamelist\n");
        return 0;
  }
  ...
  readrangetreeclimatelutfile(argv[5],argv[6],namelistrangetreeclimatename);
  readrangeherbclimatelutfile(argv[5],argv[6],namelistrangeherbclimatename);
  readrangebareclimatelutfile(argv[5],argv[6],namelistrangebareclimatename);
  ...
  readpotentialveglut(rangetreeclimatedb,1);
  readpotentialveglut(rangeherbclimatedb,2);
  readpotentialveglut(rangebareclimatedb,3);
